// This code implements the programming assignment 4.6
// in the book "An Introduction to Parallel Programming"
// by Pacheco and Malensek

// Lines that make use of original pthread read-write lock
// are commented out
